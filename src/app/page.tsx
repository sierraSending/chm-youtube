...
const initialItems: DraggableItem[] = [
  ...
  { id: 3, name: "HAL", image: "/images/HAL.png", x: 50, y: 50, description: "There is no specific artifact label for \"Hal\" in the provided document. However, there is an image caption that discusses HAL 9000 from the 1968 film 2001: A Space Odyssey." },
  { id: 4, name: "HER", image: "/images/HER.png", x: 50, y: 50, description: "There is no artifact label for \"Her\" in the provided document. The document does include an image caption about the 2013 film Her, noting that director Spike Jonze was inspired by the web-based chatbot A.L.I.C.E.." },
  { id: 5, name: "JARVIS", image: "/images/JARVIS.png", x: 50, y: 50, description: "There is no artifact label for \"Jarvis\" in the provided document. An image caption mentions J.A.R.V.I.S. as a fictional AI from the Iron Man films that inspired entrepreneurs like Mark Zuckerberg." },
  { id: 6, name: "METROPOLIS", image: "/images/METROPOLIS.png", x: 50, y: 50, description: "There is no artifact label for \"Metropolis\" in the provided document. An image caption describes the mechanical talking robot, or \"Maschinenmensch,\" featured in the 1927 film Metropolis." },
